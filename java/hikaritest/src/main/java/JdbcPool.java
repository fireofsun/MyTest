...
public class JdbcPool {
    ...
    //database address
    private static String  jdbcUrl="jdbc:postgresql://192.168.26.14:5432/equipment_analysis";
    //useName 用户名
    ...
    public static void main(String[] args){
        ...
        List result=jdbcPool.excuteQuery("select to_char(savedate,'yyyy-mm-dd hh24:mi:ss'),fic from b_elec_analysis \n" +
                "where mach_no='BF6' and fblm='SS4627'\n" +
