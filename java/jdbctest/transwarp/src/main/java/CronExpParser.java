...
public class CronExpParser
{
    ...
    public static void main(String[] args) throws IOException {
        String CRON_EXPRESSION = "0 32 01 ? * MON";
        // 生成指定日期的CRON时间序列
        ...
        FileReader reader = new FileReader("/Users/mc/codeTest/time.txt");
        BufferedReader br = new BufferedReader(reader);
        String str = null;
        FileWriter writer = new FileWriter("/Users/mc/codeTest/transTime.txt");
        ...
        while((str = br.readLine()) != null) {
            ...
            String translatedString = CronExpParser.translateToChinese(str);
            bw.write(translatedString+"\n");
        }
