...
public class CronExpParser
{
    ...
    {
        /*String CRON_EXPRESSION = "0 0 3,5,6 * * ?";
        // 生成指定日期的CRON时间序列
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("/Users/mc/Downloads/cron.csv"));//换成你的文件名
